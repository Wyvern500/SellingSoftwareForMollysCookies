from PyQt6.QtWidgets import QWidget, QLineEdit, QLabel, QVBoxLayout, QHBoxLayout, QListWidgetItem, QFileDialog
...
class InventoryManager:
    ...
    def __init__(self, parent):
        ...
        self.parent.inv_products_list_widget.itemDoubleClicked.connect(self.activate_ingredient_for_editing)
    ...
    def activate_ingredient_for_editing(self, item):
        pass
...
class ProductItemWidget(QWidget):
    ...
    def __init__(self, ingredient, parent=None):
        ...
        name_label = QLabel("Producto: ")
        name_label.setFixedHeight(20)
        name_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        name_layout.addWidget(name_label)
        self.name_line_edit = QLineEdit(self.ingredient.name)
        self.name_line_edit.setFixedHeight(20)
        name_layout.addWidget(self.name_line_edit)
        name_container.setLayout(name_layout)
        # Agregando el name al widget central
        ...
        amount_label = QLabel("Cantidad: ")
        amount_label.setFixedHeight(20)
        amount_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        amount_layout.addWidget(amount_label)
        self.amount_line_edit = QLineEdit(str(self.ingredient.amount))
        self.amount_line_edit.setFixedHeight(20)
        amount_layout.addWidget(self.amount_line_edit)
        amount_container.setLayout(amount_layout)
        # Agregando el amount al widget central
        details_layout.addWidget(amount_container)
